...
function seekTo(seconds) {
	...
	progressWrapper.dispatchEvent(new MouseEvent('mousedown', { bubbles: true, clientX: x, clientY: y }));
	progressWrapper.dispatchEvent(new MouseEvent('mouseup', { bubbles: true, clientX: x, clientY: y }));
}
