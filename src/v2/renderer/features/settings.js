...
class SettingsFeature extends Feature {
  ...
  `;
    ...
    const editorsHtml = `
      ...
      <div style="flex:1 0 400px;min-height:400px;display:flex;flex-direction:column;margin-bottom:20px;position:relative;border:1px solid var(--sclient-border);border-radius:4px;background:#0c0c0c;">
